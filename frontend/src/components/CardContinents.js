...
const CardContinents = () => {
   ...
   useEffect(() => {
      continentesSelecter.map(contynente =>
         axios.get(`https://myitinerary-claudiodmguzman.herokuapp.com/api/continentarios/${contynente.nameContinents}`)
               ...
               {filterContynente.map((contynente) => (
                  ...
                  <div className='cardContinentsContainer'>
                     ...
                     <div className='imgCardContinent'>
                        ...
                        <img src={process.env.PUBLIC_URL + `/imgContinentesGlobo/${contynente.imageGlobo}`} alt="Imagen Globo del Continente" />
                     </div>
